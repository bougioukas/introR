# Common data structures in R {#sec-structures}
...
-   Create vectors, matrices, and lists.
-   Understand the concepts of coercion and vector recycling.
-   Extract elements from a vector, a matrix, or a list.
-   Create a data frame and access its variables.
:::

 

## Atomic and generic vectors in R
...
Adding a numeric value to a logical vector converts all the elements in the vector to double (numeric) values. Logical values are converted to numbers as folowing: 
